    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          {/* Sheet */}
          <motion.div
            className="fixed inset-x-0 bottom-0 bg-white rounded-t-3xl shadow-2xl flex flex-col overflow-hidden sm:max-w-md md:max-w-lg sm:ml-[10%] sm:mr-auto"
            style={{ zIndex: 9999, y: dragY, maxHeight: '92vh' }}
            initial={{ y: '100%' }}
            animate={{ y: 0 }}
            exit={{ y: '100%' }}
