...
export const RECITATION_PINS = [
  { index: 1, name: '로마서 8:1-17', ext: 'jpg' },
  { index: 2, name: '로마서 8:18-39', ext: 'jpg' },
  { index: 3, name: '요한복음 5:19-30', ext: 'jpg' },
  { index: 4, name: '신명기 30:8-20', ext: 'jpg' },
  { index: 5, name: '복음의 수레바퀴', ext: 'jpg' },
  { index: 6, name: '마태복음 (영문)', ext: 'png' },
  { index: 7, name: '요한1서 4:7-21', ext: 'png' },
  { index: 8, name: '고린도전서 13장', ext: 'png' },
  { index: 9, name: '시편 34편', ext: 'png' },
  { index: 10, name: '시편 23편', ext: 'png' },
  { index: 11, name: '출애굽기 20:3-17', ext: 'png' },
  { index: 12, name: '시편 100:1-5', ext: 'png' },
  { index: 13, name: '시편 1편', ext: 'png' },
  { index: 14, name: '로마서 6:1-13', ext: 'png' },
  { index: 15, name: '요한복음 10:1-15', ext: 'png' },
  { index: 16, name: '고린도전서 15:1-11', ext: 'png' },
  { index: 17, name: '잠언 3:1-13', ext: 'png' },
  { index: 18, name: '시편 62:1-12', ext: 'png' },
  { index: 19, name: '빌립보서 4:1-13', ext: 'png' },
  { index: 20, name: '마태복음 5:13-26', ext: 'png' },
  { index: 21, name: '이사야 53장', ext: 'png' },
  { index: 22, name: '이사야 40:1-8', ext: 'jpg' },
  { index: 23, name: '갈라디아서 2:11-21', ext: 'png' },
  { index: 24, name: '히브리서', ext: 'png' },
  { index: 25, name: '에베소서', ext: 'png' },
  { index: 26, name: '베드로전서 1:13-25', ext: 'png' },
  { index: 27, name: '마가복음', ext: 'png' },
] as const;
